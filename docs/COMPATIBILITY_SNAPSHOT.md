...
| SQLCipher | https://www.zetetic.net/sqlcipher/sqlcipher-api/ | Issue #7 candidate pins `sqlcipher3` 0.6.2 / SQLCipher 4.12.0, raw 32-byte key, encrypted WAL, integrity check, eight-wheel component/license inventory and conservative SPDX record; known OpenSSL 3.6.0 and SQLite 3.51.1 findings plus license/signing decisions block acceptance |
